    ...
    <div className="bg-slate-900">
      ...
      {isLoading ? (
        ...
        <div className="flex flex-wrap gap-9 justify-center pb-5 ">
          {Array.isArray(data) && data.slice(0, 3).map((product) => (
          ...
          <div className="cursor-pointer group w-72 h-auto bg-indigo-600 shadow-lg rounded-lg p-4 flex items-center justify-center border border-transparent hover:border-indigo-100 transition duration-300">
            <Link to="/products" className="text-xl text-white font-semibold">
              See All Products
            </Link>
          </div>
        </div>
